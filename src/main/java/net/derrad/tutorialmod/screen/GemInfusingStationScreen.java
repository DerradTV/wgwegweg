package net.derrad.tutorialmod.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import net.derrad.tutorialmod.TutorialMod;
import net.derrad.tutorialmod.screen.renderer.EnergyInfoArea;
import net.derrad.tutorialmod.screen.renderer.FluidTankRenderer;
import net.derrad.tutorialmod.util.MouseUtil;
